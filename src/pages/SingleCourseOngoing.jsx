          ...
          <div className="single-courses-complete-wrap">
            ...
            <div className="single-courses-complete-bottom">
              <div className="ongoing-section-wrap mt-32">
                <div className="lesson-tabbar mt-24">
                  ...
                  <div className="lesson-tabbar-content mt-24">
                    <div className="lesson-tabbar-title">
                      <span className="tab-lesson1">2 - How Grids Work</span>
                    ...
                    <div className="tabbar-bottom">
                      ...
                      <div className="play-btn-txt">Why Those Breakpoints?</div>
                  ...
                  <div className="lesson-tabbar-content mt-24">
                    <div className="lesson-tabbar-title">
                      <span className="tab-lesson1">3 - Grids in Figma</span>
                    ...
                    <div className="tabbar-bottom">
                      <div className="lesson-play-btn lesson-play-btn-svg">
                        <div>
                  ...
                  <div className="lesson-tabbar-content mt-24">
                    ...
                    <div className="tabbar-bottom">
                      ...
                      <div className="play-btn-txt">Responsive CSS Grid</div>
                      <div className="play-btn-time">03:42</div>
                    </div>
                  </div>
                </div>
                <div className="start-course-btn">
                  <Link to="/single-course-description">Continue Course</Link>
                </div>
              </div>
            </div>
          </div>
...
export default SingleCourseOngoing;
