      ...
      <section id="checkout-screen">
          ...
          <div className="container">
            <div className="review-first-sec-wrap mt-32">
              <div className="overall-review">
                <h2 className="third-txt1">Payment Method</h2>
              </div>
              ...
              <Slider {...settings}>
                ...
                <div className="check-select-mode">
                  <input
                    ...
                    name="payment-option"
                  />
                  <label className="payment-custom-radio " htmlFor="payment-2">
                    <svg
                      width="50"
                      height="22"
                      viewBox="0 0 50 22"
                ...
                <div className="check-select-mode">
                  <input
                    ...
                    name="payment-option"
                  />
                  <label className="payment-custom-radio " htmlFor="payment-3">
                    <svg
                      width="50"
                      height="17"
                      viewBox="0 0 50 17"
                ...
                <div className="check-select-mode">
                  <input
                    ...
                    name="payment-option"
                  />
                  <label className="payment-custom-radio " htmlFor="payment-4">
                    <svg
                      width="23"
                      height="28"
                      viewBox="0 0 23 28"
                ...
                <div className="check-select-mode">
                  <input
                    ...
                    name="payment-option"
                  />
                  <label className="payment-custom-radio " htmlFor="payment-5">
                    <svg
                      width="47"
                      height="28"
                      viewBox="0 0 47 28"
                ...
                <div className="check-select-mode">
                  <input
                    ...
                    name="payment-option"
                  />
                  <label className="payment-custom-radio " htmlFor="payment-6">
                    <svg
                      width="42"
                      height="27"
                      viewBox="0 0 42 27"
        ...
        <div className="container">
          <div className="check-out-payment">
            <div className="check-out-payment-wrap">
              <div className="check-out-coupon-sec">
                <div className="review-first-sec-wrap mt-32">
                  <div className="overall-review">
                    <h2 className="third-txt1">Apply Coupon</h2>
                  </div>
                  <div className="view-all-descrip">
              ...
              <div className="checkout-price-sec mt-32">
                <div className="checkout-price-sec-wrap">
                  <h3 className="check-txtt5">Price</h3>
                  <div className="checkoutpage-boder"></div>
                  <div className="checkout-price-content">
                    <div className="checkout-price mt-12">
                      <span className="check-price1">1 items</span>
                      <span className="check-price1">$149.00</span>
                    </div>
                    <div className="checkout-price mt-12">
                      <span className="check-price1">Coupon Offer</span>
                      <span className="check-price1 color-green">- $00.00</span>
                    </div>
                    <div className="checkout-price mt-12">
                      <span className="check-price2">Total Price</span>
                      <span className="check-price2">$149.00</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="pay-now-btn mt-32">
                <Link to="/payment-screen">Pay Now</Link>
              </div>
            </div>
          </div>
        </div>
