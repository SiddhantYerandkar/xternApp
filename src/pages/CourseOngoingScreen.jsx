...
import OngoingImg1 from "../assets/images/courses/ongoing-1.png";
import OngoingImg2 from "../assets/images/courses/ongoing-2.png";
import OngoingImg3 from "../assets/images/courses/ongoing-3.png";
import CompletedImg1 from "../assets/images/courses/completed1.png";
import CompletedImg2 from "../assets/images/courses/completed2.png";
            ...
            <div className="tab-content" id="pills-tabContent">
              ...
              >
                <div className="ongoing-section-details mt-16">
                  <Link to="/single-course-ongoing">
                    <div className="ongoing-section-details-wrap category-redirect">
                      <div className="ongoing-first">
                        <img src={OngoingImg1} alt="course-img" />
                      </div>
                        ...
                        <div className="ongoing-second-wrap">
                          <div className="ongoing-details">
                            ...
                            <div className="mt-16">
                              ...
                              <span className="ongoing-txt2">3h 30m</span>
                            </div>
                          </div>
                          <div className="ongoing-progressbar">
                            <ProgressCircle
                              percent={80}
                              colorClass="purple-progressbar"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <Link to="/single-course-ongoing">
                    <div className="ongoing-section-details-wrap category-redirect mt-16">
                      <div className="ongoing-first">
                        <img src={OngoingImg2} alt="course-img" />
                      </div>
                      <div className="ongoing-second">
                        <div className="ongoing-second-wrap">
                          <div className="ongoing-details">
                  ...
                  <Link to="/single-course-ongoing">
                    <div className="ongoing-section-details-wrap category-redirect mt-16">
                      <div className="ongoing-first">
                        <img src={OngoingImg3} alt="course-img" />
                      </div>
                      <div className="ongoing-second">
                        <div className="ongoing-second-wrap">
                          <div className="ongoing-details">
              ...
              >
                <div className="Completed-section-details mt-16">
                  <Link to="/single-course-complete">
                    <div className="ongoing-section-details-wrap complete-course">
                      <div className="ongoing-first">
                        <img src={CompletedImg1} alt="course-img" />
                      </div>
                      <div className="ongoing-second">
                        <div className="ongoing-second-wrap">
                          <div className="ongoing-details">
                            ...
                            <div className="mt-16">
                              ...
                              <span className="ongoing-txt2">2h 30m</span>
                            </div>
                          </div>
                          <div className="ongoing-progressbar">
                            <ProgressCircle
                  ...
                  <Link to="/single-course-complete">
                    <div className="ongoing-section-details-wrap mt-16 complete-course">
                      <div className="ongoing-first">
                        <img src={CompletedImg2} alt="course-img" />
                      </div>
                      <div className="ongoing-second">
                        <div className="ongoing-second-wrap">
                          <div className="ongoing-details">
                            <h2 className="ongoing-txt1">
                              Become a UX Designer | Learn the...
                            </h2>
                            <div className="mt-16">
                              <span className="ongoing-img">
                                <img src={TimeIcon} alt="time-icon" />
          ...
          <div className="home-navigation-menu">
            <div className="bottom-panel nagivation-menu-wrap">
              <ul className="bootom-tabbar">
                ...
                <li className="active">
                  <Link to="/course-ongoing-screen" className="active">
                    <svg
                      className="active"
                      width="24"
                      height="24"
